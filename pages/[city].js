...
const CITY_DATA = {
    ...
    'grybow': {
        ...
        locative: 'w Grybowie',
        genitive: 'z Grybowa',
        desc: 'Mniejsze, ambitne miasto to doskonały start dla ogólnopolskiego e-commerce ukrytego z dala od drogich biurowców. Prowadząc biznes w Grybowie, masz ogromną szansę by zoptymalizować koszty prowadzenia działalności logistycznej przy jednoczesnym generowaniu sprzedaży na całą Polskę. Zbuduj z nami centralę cyfrowego handlu w samym Grybowie.',
    ...
    'nowy-sacz': {
        ...
        desc: 'Zagłębie potężnych firm uczy, że na Sądecczyźnie wygrywa niska marża skalowana z ogromnym wolumenem obrotów. Oferujemy w Nowym Sączu najnowocześniejsze standardy budowania sklepów e-commerce. Projektujemy systemy B2B zdolne współpracować z wiodącymi magazynami.',
    ...
    'rzeszow': {
        ...
        genitive: 'z Rzeszowa',
        desc: 'Stolica Podkarpacia, stolica innowacji. Prowadząc firmę w Rzeszowie potrzebujesz niezawodnych technologii wspierających inteligentne wzrosty zysków ze sprzedaży przez internet. Obsługujemy firmy rzeszowskie integrując sprzedaż na Amazonie i pełne zaplecze logistyczne.',
    ...
    'kielce': {
        ...
        locative: 'w Kielcach',
        genitive: 'z Kielc',
        desc: 'Silny ośrodek wystawienniczy z ogromnym potencjałem e-commerce. Przedsiębiorcy z Kielc posiadający u nas obsługę technologiczną mogą liczyć na stabilność serwerową przez cały sezon handlowy. Od projektowania stron www po zawiłe integracje z BaseLinkerem.',
    ...
    'warszawa': {
        ...
        genitive: 'z Warszawy',
        desc: 'Krajowe centrum biznesu, w którym bezkompromisowa jakość i czas to podstawa wygranej rynkowej. Dostarczamy potężne sklepy Headless Commerce gotowe obsłużyć olbrzymi ruch konsumencki. Dla firm z Warszawy gwarantujemy wsparcie z wykorzystaniem Next.js i optymalizacji konwersji.',
        mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d156388.35422479093!2d20.92111326444855!3d52.23306532087524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471ecc669a869f01%3A0x72f0be2a88ead3fc!2sWarszawa!5e0!3m2!1spl!2spl!4v1700000000000!5m2!1spl!2spl'
    }
}
...
export default function LokalnaOferta({ cityCode, data }) {
    return (
        <Layout>
            <Head>
                <title>Profesjonalne strony internetowe {data.locative} - Webspanner</title>
                <meta name="description" content={`Nowoczesne strony WWW i Sklepy e-commerce przygotowane dla firm ${data.genitive}. Odkryj wydajność z Webspanner.`} />
            </Head>

            {/* Hero SEO */}
            <section className="py-24 bg-gray-50 relative overflow-hidden">
                <div className="absolute top-0 w-full h-[50vh] bg-[#7C3AED]/5 pointer-events-none" />
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            <span className="bg-[#7C3AED]/10 text-[#7C3AED] px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2">
                                <MapPin size={14} /> Rejon Ofertowy: {data.base}
                            </span>
                        </div>
                        <h1 className="text-5xl md:text-8xl font-black mb-8 leading-tight tracking-tighter text-gray-900">
                            ...
                            <span className="text-[#7C3AED] italic pr-2">
                                {data.locative}
                            </span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <Link href="/kontakt">
                                <button className="px-10 py-5 bg-[#7C3AED] hover:bg-[#6D28D9] text-white rounded-xl font-bold flex items-center justify-center gap-3 w-full sm:w-auto transition-colors shadow-lg">
                                    Napisz do mnie <ArrowRight size={20} />
                                </button>
                            </Link>
                            <Link href="/portfolio">
                                <button className="px-10 py-5 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-xl font-bold flex items-center justify-center w-full sm:w-auto transition-colors shadow-sm">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <ul className="space-y-4">
                                {['Zoptymalizowane SEO pozyskujące lokalny ruch', 'Integracja Płatności (Przelewy24, PayU)', 'Automatyzacja procesów logistycznych (BaseLinker)', 'Piekielnie szybki czas ładowania (PageSpeed > 95)'].map((tick, i) => (
                                    <li key={i} className="flex gap-4 items-center font-medium text-gray-700">
                                        <div className="w-8 h-8 rounded-full bg-[#7C3AED]/10 flex items-center justify-center text-[#7C3AED] shrink-0">✓</div>
                                        {tick}
                                    </li>
                                ))}
                            </ul>
                        ...
                        >
                            <div className="flex gap-6 items-start">
                                <div className="w-16 h-16 rounded-2xl bg-[#7C3AED]/10 text-[#7C3AED] flex items-center justify-center shrink-0">
                                    <Search size={32} />
                                </div>
                                <div>
